 ...
 *
 * -01: Use Spring TestContext Framework
...
/* -02: Annotate all 'Stub*Repository' classes with @Repository
...
/* -03: Assign the 'jdbc' profile to all Jdbc*Repository classes
...
/* -07: Use "jdbc" and "jndi" as active profiles
...
/* -08 (Optional): Create an inner static class from TestInfrastructureConfig
